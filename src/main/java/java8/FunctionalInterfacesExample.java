...
public class FunctionalInterfacesExample {
    private final static Consumer<Student> consumer1 = (student) -> System.out.println(student.getId());
    private final static Consumer<Student> consumer2 = (student) -> System.out.println(student.getName());
    private final static List<Student> studentList = StudentDatabase.addStudents();
    private final static Predicate<Integer> predicate1 = (i) -> i % 2 == 0;
    private final static Predicate<Integer> predicate2 = (i) -> i % 5 == 0;
    private final static Predicate<Student> pr1 = (student) -> student.getId() >= 2;
    private final static Predicate<Student> pr2 = (student) -> student.getGrade() > 4;
    private final static BiPredicate<Student, Student> bipr = (i, j) -> i.getGrade() < 4 && j.getId() == 4;
    private final static BiPredicate<Student, Student> bipr1 = (i, j) -> i.getName().equals("Ira") && j.getId() < 4;
